...
$sql = "SELECT id, title, content, image, created_at FROM sports_news ORDER BY created_at DESC";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '     </figure>
                          <div class="course-1-content pb-4">
                            ...
                            <a href="sports-news-details.php?id=' . $row['id'] . '" class="btn btn-primary px-4">See More</a> <!-- See More Button -->
                          </div>
                        </div>
                      </div>';
            }
